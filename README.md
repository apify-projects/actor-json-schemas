...
-   **`actor.json`**: For defining the Actor's configuration.
    ...
    -   URL: `https://apify-projects.github.io/actor-json-schemas/actor.ide.json?v=0.7`

-   **`dataset.json`**: For validating data in a dataset.

    -   URL: `https://apify-projects.github.io/actor-json-schemas/dataset.ide.json?v=0.7`

-   **`input.json`**: For the Actor's input.

    -   URL: `https://apify-projects.github.io/actor-json-schemas/input.ide.json?v=0.7`

-   **`key-value-store.json`**: For data within the key-value store.

    -   URL: `https://apify-projects.github.io/actor-json-schemas/key-value-store.ide.json?v=0.7`

-   **`output.json`**: For the Actor's output.

    -   URL: `https://apify-projects.github.io/actor-json-schemas/output.ide.json?v=0.7`
